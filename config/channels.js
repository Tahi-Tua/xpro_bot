...
module.exports = {
  ...
  YOUTUBE_ANNOUNCEMENTS_CHANNEL_ID: env("YOUTUBE_ANNOUNCEMENTS_CHANNEL_ID", ""),
  YOUTUBE_ANNOUNCEMENTS_CHANNEL_NAME: env("YOUTUBE_ANNOUNCEMENTS_CHANNEL_NAME", "┌・📹・youtube-videos"),
