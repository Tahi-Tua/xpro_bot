...
module.exports = {
  ...
  YOUTUBE_ANNOUNCEMENTS_CHANNEL_ID: env("YOUTUBE_ANNOUNCEMENTS_CHANNEL_ID", "1534714957008998620"),
  YOUTUBE_ANNOUNCEMENTS_CHANNEL_NAME: env("YOUTUBE_ANNOUNCEMENTS_CHANNEL_NAME", "xpro"),
  ...
  PRIVATE_CHANNEL_IDS: csv(process.env.PRIVATE_CHANNEL_IDS, [
    ...
    "1513356233254375454",    // RANKING_LOG_CHANNEL_ID
  ]),
  ...
  GUEST_ROLE_ID: env("GUEST_ROLE_ID", "1381603842856321096"),
  VISITOR_ROLE_NAME: env("VISITOR_ROLE_NAME", "Visitor"),
